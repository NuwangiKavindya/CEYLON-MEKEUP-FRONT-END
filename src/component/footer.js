      ...
      <div className="container-footer" style={{ display: 'flex', justifyContent: 'flex-start', alignItems: 'center', flexWrap: 'wrap', padding: '20px', height: '400px' }}>
        ...
        <div style={{ width: '33%' }}>
          ...
          <div class="social-icons" style={{ display: 'flex', flexDirection: 'row', gap: '15px', marginTop: '20px' }}>
            <a href="https://facebook.com" target="_blank" rel="noreferrer"><i class="fab fa-facebook-f fa-2x"></i></a>
            <a href="https://twitter.com" target="_blank" rel="noreferrer"><i class="fab fa-twitter fa-2x"></i></a>
            <a href="https://instagram.com" target="_blank" rel="noreferrer"><i class="fab fa-instagram fa-2x"></i></a>
            <a href="https://whatsapp.com" target="_blank" rel="noreferrer"><i class="fab fa-whatsapp fa-2x"></i></a>
          </div>
